...
def camera_process(img_label, filters):
...
def ex_camera_stripes(noise_level=100, sigma=(1000, 0.1), theta=0):
    ...
    return camera_process('camera_stripes', filters)
...
def ex_camera_curtains(noise_level=20, sigma=(3, 40), theta=0):
    ...
    return camera_process('camera_curtains', filters)
...
def ex_fib_sem(noise_level=30, sigma=(1, 30), theta=358):
    ...
    return img_process(img_label, filters, img, None)
